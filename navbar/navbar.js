...
<nav  id="nav">
    <div class="Upper_section">
        <div class="logo_section">
            <a href="./index.html"><img src="./M (4).png" alt="Not found" /></a>
        </div>
 ...
 <div class="Lower_section">
        <div class="testing">
            ...
            <div class="hidden_div second_hidden_box">
                <ul>
                    <li><a href = "./product_page_CovidEssentials.html">All Medicines</a></li>
        ...
        <div>
            ...
            <h5>&nbsp; &nbsp; <a class="wellness_link" href="./product_page_Cough&Cold.html">Wellness</a></h5>
        ...
        <div class="testing">
            ...
            <div class="hidden_div">
                <ul>
                    <li><a href="./product_page_beauty_personalcare.html">Personal Care</a></li>
                    <li><a href="./product_page_FaceMakeup.html">Make-Up</a></li>
                    <li><a href="./product_page_Hair.html">Hair</a></li>
                    <li><a href="./product_page_Men'sGrooming.html">Skin Care</a></li>
                    <li><a href="./product_page_Devices.html">Tool's & Appliances</a></li>
                    <li><a href="./product_page_Mom&Baby.html">Mom & Baby</a></li>
                </ul>
            </div>
